...
public partial class WCView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            LblName.Text = "Workshop Conducted By " + name.ToString();
            BindDetails();
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("content-disposition", "attachment; filename=WrkShpCond.xls");
