...
<body>
    ...
    <div class="auto-style1">
        ...
        <table class="auto-style3">
            ...
            <tr>
                <td class="auto-style4">Organization Name</td>
                <td>
            ...
            <tr>
                <td class="auto-style4">No of Students</td>
                <td>
            ...
            <tr>
                <td class="auto-style5">Photos</td>
                <td>

                    <asp:FileUpload ID="FileUpload1" runat="server" />
&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" Font-Bold="True" Text="Upload" />
...
&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button3" runat="server" Font-Bold="True" Text="View" />
    </form>
</body>
</html>