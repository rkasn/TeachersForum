...
public partial class IVView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            LblName.Text = "Industrial Visit By " + name.ToString();
            BindDetails();
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("content-disposition", "attachment; filename=IndVisit.xls");
