...
public partial class Change_Admin_Password : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        conn.Open();
        string checkPassword = "select Password from AdminTable where UserName = '" + Request.QueryString.ToString() + "'";
        ...
        if (password == TextBoxOP.Text)
        {
            ...
            {
                conn.Open();
                string changePassword = "UPDATE AdminTable SET Password = '" + TextBoxNP.Text + "' where UserName = '" + Request.QueryString.ToString() + "'";
