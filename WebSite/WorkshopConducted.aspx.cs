...
public partial class WorkshopConducted : System.Web.UI.Page
{
    ...
    {
        Con.Open();
        string SelectQuery = "SELECT * FROM WorkCond WHERE UserName='" + Request.QueryString.ToString() + "'";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        Con.Open();
        string DeleteQuery = "DELETE FROM WorkCond WHERE ID=" + ID;
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        TextBox TxtTOA = (TextBox)GridView1.Rows[e.RowIndex].FindControl("TxtTOA");
        ...
        Con.Open();
        string UpdateQuery = "UPDATE WorkCond SET Name='" + TxtName.Text + "',Domain='" + TxtDomain.Text + "',Venue='" + TxtVenue.Text + "',TOA='" + TxtTOA.Text + "',NOD='" + TxtNOD.Text + "',StartDate='" + TxtStartDate.Text + "',EndDate='" + TxtEndDate.Text + "' WHERE ID=" + ID;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("AddNew"))
        {
            ...
            TextBox TxtTOA = (TextBox)GridView1.FooterRow.FindControl("TxtFtrTOA");
            ...
            Con.Open();
            string InsertQuerry = "INSERT INTO WorkCond(UserName,Name,Domain,Venue,TOA,NOD,StartDate,EndDate) VALUES('" + Request.QueryString.ToString() + "','" + TxtName.Text + "','" + TxtDomain.Text + "','" + TxtVenue.Text + "','" + TxtTOA.Text + "','" + TxtNOD.Text + "','" + TxtStartDate.Text + "','" + TxtEndDate.Text + "')";
